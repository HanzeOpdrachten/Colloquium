...
<div class="form-group">
    ...
    <input type="text" class="form__input {{ $errors->has('location') ? 'is-invalid' : '' }}" name="location" id="location" value="{{ old('location') }}" placeholder="E.g.: ZP09/D220">
